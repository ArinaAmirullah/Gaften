...
<div class="font-size-lg text-primary pt-2">RM 125.00</div>
</div>
</div>
...
<div class="font-size-lg text-primary pt-2">RM 134.99</div>
</div>
</div>
<div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem;">
<div class="form-group mb-2">
...
<a class="font-size-sm" href="/album"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left" style="width: 1rem; height: 1rem;"><polyline points="15 18 9 12 15 6"></polyline></svg>Continue shopping</a>

</div>

<div class="col-xl-3 col-md-4 pt-3 pt-md-0">
<h2 class="h6 px-4 py-3 bg-secondary text-center">Subtotal</h2>
 <div class="h3 font-weight-semibold text-center py-3">RM 325.00</div>
<hr>
...
<?php /**PATH /Users/nurulaziraamirullah/project/resources/views/cart.blade.php ENDPATH**/ ?>